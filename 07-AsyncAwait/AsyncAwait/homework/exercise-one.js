...
function problemB() {
  ...
  // AsyncAwait version
  async function p1() {
    const stanza = await promisifiedReadFile("poem-one/stanza-02.txt");
    blue(stanza);
  }
  async function p2() {
    const stanza = await promisifiedReadFile("poem-one/stanza-03.txt");
    blue(stanza);
  }
  p1();
  p2();
...
function problemD() {
  ...
  async function p1() {
    try {
      const stanza = await promisifiedReadFile("poem-one/stanza-04.txt");
      blue(stanza);
    } catch (e) {
      magenta(e);
    }
